...
public class ProjetView {
	...
	private JButton envoyer = new JButton("Envoyer seuil");
	...
	void envoyerData(ActionListener listenForSending) {
		envoyer.addActionListener(listenForSending);
	}
}